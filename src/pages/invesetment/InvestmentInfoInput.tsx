  ...
  return (
    <Wrapper>
      ...
      <NoticeWrapper>
        ...
        <NoticeList>
          <li>
            투자 시 내 보유금액이 입력한 투자금액만큼 자동으로 인출되며, 투자한
            원금은 마지막 상환 회차에 돌려받을 수 있어요.
          </li>
          ...
          <li>
            투자자를 통한 희망 대출금이 모두 모였을 경우 대출이 시작되어요. 매달
            상환일은 대출이 시작된 날 기준으로 계산되며, 대출이 시작된 날이 매달
            마지막 날일 경우에는 모든 상환일이 일괄적으로 각 달의 마지막 날로
            결정되어요.
          </li>
          <Spacer height="0.75rem" />
